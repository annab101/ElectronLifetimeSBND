...
int main(int argc, char**argv) {
    ...
    if(codeConfig == 1){
        ...
        for(int i = 1; i <= maxWireGroup; i++){
            ...
            expoFit_xDriftL = fitter(MPVplot_xDrift_wires, expoParams_xDriftL.lb, expoParams_xDriftL.ub, expoParams_xDriftL.fp, expoParams_xDriftL.efp, expoParams_xDriftL.cov, "expoX");
			expoFit_xDriftR = fitter(MPVplot_xDrift_wires, expoParams_xDriftR.lb, expoParams_xDriftR.ub, expoParams_xDriftR.fp, expoParams_xDriftR.efp, expoParams_xDriftR.cov, "expoX");
			expoFit_tDriftL = fitter(MPVplot_tDriftL_wires, expoParams_tDriftL.lb, expoParams_tDriftL.ub, expoParams_tDriftL.fp, expoParams_tDriftL.efp, expoParams_tDriftL.cov, "expoT");
			expoFit_tDriftR = fitter(MPVplot_tDriftR_wires, expoParams_tDriftR.lb, expoParams_tDriftR.ub, expoParams_tDriftR.fp, expoParams_tDriftR.efp, expoParams_tDriftR.cov, "expoT");
    ...
    if(codeConfig == 2){
        ...
        for(int i = 1; i <= maxWireGroup; i++){
            ...
            expoFit_xDriftL = fitter(MPVplot_xDrift_hits, expoParams_xDriftL.lb, expoParams_xDriftL.ub, expoParams_xDriftL.fp, expoParams_xDriftL.efp, expoParams_xDriftL.cov, "expoX");
			expoFit_xDriftR = fitter(MPVplot_xDrift_hits, expoParams_xDriftR.lb, expoParams_xDriftR.ub, expoParams_xDriftR.fp, expoParams_xDriftR.efp, expoParams_xDriftR.cov, "expoX");
			expoFit_tDriftL = fitter(MPVplot_tDriftL_hits, expoParams_tDriftL.lb, expoParams_tDriftL.ub, expoParams_tDriftL.fp, expoParams_tDriftL.efp, expoParams_tDriftL.cov, "expoT");
			expoFit_tDriftR = fitter(MPVplot_tDriftR_hits, expoParams_tDriftR.lb, expoParams_tDriftR.ub, expoParams_tDriftR.fp, expoParams_tDriftR.efp, expoParams_tDriftR.cov, "expoT");
    ...
    if(codeConfig == 3){
        ...
        for(int i = 0; i < angBins/2; i++){
            ...
            expoFit_xDriftL_toW = fitter(MPVplot_xDrift_toW, expoParams_xDriftL_toW.lb, expoParams_xDriftL_toW.ub, expoParams_xDriftL_toW.fp, expoParams_xDriftL_toW.efp, expoParams_xDriftL_toW.cov, "expoX");
			expoFit_xDriftR_toW = fitter(MPVplot_xDrift_toW, expoParams_xDriftR_toW.lb, expoParams_xDriftR_toW.ub, expoParams_xDriftR_toW.fp, expoParams_xDriftR_toW.efp, expoParams_xDriftR_toW.cov, "expoX");
			expoFit_tDriftL_toW = fitter(MPVplot_tDriftL_toW, expoParams_tDriftL_toW.lb, expoParams_tDriftL_toW.ub, expoParams_tDriftL_toW.fp, expoParams_tDriftL_toW.efp, expoParams_tDriftL_toW.cov, "expoT");
			expoFit_tDriftR_toW = fitter(MPVplot_tDriftR_toW, expoParams_tDriftR_toW.lb, expoParams_tDriftR_toW.ub, expoParams_tDriftR_toW.fp, expoParams_tDriftR_toW.efp, expoParams_tDriftR_toW.cov, "expoT");

			expoFit_xDriftL_toE = fitter(MPVplot_xDrift_toE, expoParams_xDriftL_toE.lb, expoParams_xDriftL_toE.ub, expoParams_xDriftL_toE.fp, expoParams_xDriftL_toE.efp, expoParams_xDriftL_toE.cov, "expoX");
			expoFit_xDriftR_toE = fitter(MPVplot_xDrift_toE, expoParams_xDriftR_toE.lb, expoParams_xDriftR_toE.ub, expoParams_xDriftR_toE.fp, expoParams_xDriftR_toE.efp, expoParams_xDriftR_toE.cov, "expoX");
			expoFit_tDriftL_toE = fitter(MPVplot_tDriftL_toE, expoParams_tDriftL_toE.lb, expoParams_tDriftL_toE.ub, expoParams_tDriftL_toE.fp, expoParams_tDriftL_toE.efp, expoParams_tDriftL_toE.cov, "expoT");
			expoFit_tDriftR_toE = fitter(MPVplot_tDriftR_toE, expoParams_tDriftR_toE.lb, expoParams_tDriftR_toE.ub, expoParams_tDriftR_toE.fp, expoParams_tDriftR_toE.efp, expoParams_tDriftR_toE.cov, "expoT");
