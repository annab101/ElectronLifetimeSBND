...
int main(int argc, char**argv) {
    ...
    TFile f((saveLoc + dataset  + "_" + configLabel + "/dQdxCorrected_hist_" + configLabel + "_" + dataset + "_" + tag + ".root").c_str());
    ...
    if(distOrTime == 0){
        ...
        h->Draw("COLZ");
        saveFig(c_plain, saveLoc + dataset  + "_" + configLabel + "/plot_dQdxCorrected_xDrift_" + histName + tag);
    ...
    if(distOrTime == 1){
        ...
        pad2->cd();
        hR->Draw("COLZ");
        saveFig(c_split, saveLoc + dataset  + "_" + configLabel + "/plot_dQdxCorrected_tDrift_" + histName + tag);
