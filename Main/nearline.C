...
void nearline() {
    ...
    std::string filename = "/exp/sbnd/data/users/abeever/nearlineFull.root";
    ...
    TTreeReader treereader("/caloskim/TrackCaloSkim", f);
